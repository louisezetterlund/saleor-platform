...
class Q41f8381619e35b0cb3bb5617e375cee2Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"gte": "110"}, "warehouseIds": ["V2FyZWhvdXNlOjQyOGY2NmM4LTliNTEtNDA4Ny04YjhiLWUzNmUxYzA0YzljNw=="]}}}, "operationName": ""}
JSON;
