...
class Q75e9fc773e995599a383b535ddafd836Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"lte": "80", "gte": "20"}, "warehouseIds": ["V2FyZWhvdXNlOmZmODNhNWNhLTFkYTItNDkyOS05NmRjLTQwOTNhZjY2MGI2OA==", "V2FyZWhvdXNlOjgzZmFmMTY2LTkyMzAtNDIxZS04N2Y0LWE3NzkxNjFiN2M1MA=="]}}}, "operationName": ""}
JSON;
