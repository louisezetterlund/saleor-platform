...
class Q5b16154828c2553b874ecbe21ef49432Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"gte": "10"}, "warehouseIds": ["V2FyZWhvdXNlOjI4MmI3NTI4LThkODktNDI1OC1iOGI4LTFmY2YwMDA3Mzg1Yw=="]}}}, "operationName": ""}
JSON;
