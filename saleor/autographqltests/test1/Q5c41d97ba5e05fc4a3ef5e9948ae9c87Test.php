...
class Q5c41d97ba5e05fc4a3ef5e9948ae9c87Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"lte": "120", "gte": "40"}, "warehouseIds": ["V2FyZWhvdXNlOmJlM2NiMjE1LWY0YzEtNDk5MC05ZDY1LTdhYjE3NjFjMmE3Zg==", "V2FyZWhvdXNlOjg3Yjc3YWRiLWZiMDQtNGYzMy1iZmQ0LTMxYjk1YmIwNzRlZA=="]}}}, "operationName": ""}
JSON;
