...
class Q0d5dde4d789f5b26a675250af34df182Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"lte": "80", "gte": "20"}, "warehouseIds": ["V2FyZWhvdXNlOmQ0ZGJhNjk4LWRjZmMtNDk2NC1hY2NhLWRlMmI4Mjk2NTM3Yg==", "V2FyZWhvdXNlOjg4Y2UyNTA4LTM5MWItNGQ1OS05MzA0LWUzNGZkM2IzYTc2Yg=="]}}}, "operationName": ""}
JSON;
