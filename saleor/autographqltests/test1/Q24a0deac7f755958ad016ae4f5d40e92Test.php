...
class Q24a0deac7f755958ad016ae4f5d40e92Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"lte": "80", "gte": "20"}, "warehouseIds": ["V2FyZWhvdXNlOjJhMjhkMmE0LWQ1YjQtNDdiZi05MGExLWNiNGEwZTYxYTc1YQ==", "V2FyZWhvdXNlOjM1YmMzNDU1LWM1ZmMtNDkxZS1hNTVlLWY4MTBkNWZhZDAwZQ=="]}}}, "operationName": ""}
JSON;
