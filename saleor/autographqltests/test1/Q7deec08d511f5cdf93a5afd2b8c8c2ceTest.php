...
class Q7deec08d511f5cdf93a5afd2b8c8c2ceTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"gte": "10"}, "warehouseIds": ["V2FyZWhvdXNlOmNkNzFlMTA5LTdlZGQtNGQ4Yi04YmEwLTQ0NWFkNmRhNGZlMg=="]}}}, "operationName": ""}
JSON;
