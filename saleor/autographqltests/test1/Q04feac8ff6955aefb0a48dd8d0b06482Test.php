...
class Q04feac8ff6955aefb0a48dd8d0b06482Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n    query($nodeID: ID!) {\n        attributes(first: 20, filter: { inCategory: $nodeID }) {\n            edges {\n                node {\n                    id\n                    name\n                    slug\n                }\n            }\n        }\n    }\n    ", "variables": {"nodeID": "Q2F0ZWdvcnk6MjUz"}, "operationName": ""}
JSON;
