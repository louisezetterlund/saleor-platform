...
class Q9b3d606e68bb559ea52e124f20329d6bTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query User($id: ID!) {\n            user(id: $id) {\n                email\n                firstName\n                lastName\n                isStaff\n                isActive\n                addresses {\n                    id\n                    isDefaultShippingAddress\n                    isDefaultBillingAddress\n                }\n                orders {\n                    totalCount\n                }\n                dateJoined\n                lastLogin\n                defaultShippingAddress {\n                    firstName\n                    lastName\n                    companyName\n                    streetAddress1\n                    streetAddress2\n                    city\n                    cityArea\n                    postalCode\n                    countryArea\n                    phone\n                    country {\n                        code\n                    }\n                    isDefaultShippingAddress\n                    isDefaultBillingAddress\n                }\n                defaultBillingAddress {\n                    firstName\n                    lastName\n                    companyName\n                    streetAddress1\n                    streetAddress2\n                    city\n                    cityArea\n                    postalCode\n                    countryArea\n                    phone\n                    country {\n                        code\n                    }\n                    isDefaultShippingAddress\n                    isDefaultBillingAddress\n                }\n                avatar {\n                    url\n                }\n                permissions {\n                    code\n                    name\n                }\n                userPermissions {\n                    code\n                    name\n                }\n                permissionGroups {\n                    name\n                    permissions {\n                        code\n                    }\n                }\n            }\n        }\n    ", "variables": {"id": "VXNlcjo1Mzk="}, "operationName": ""}
JSON;
        ...
        $this->assertArrayHasKey('name', $responseContent['user']['userPermissions'][$g]);
        
        $this->assertNotNull($responseContent['user']['userPermissions'][$g]['name']);
        
        $this->assertIsString($responseContent['user']['userPermissions'][$g]['name']);
