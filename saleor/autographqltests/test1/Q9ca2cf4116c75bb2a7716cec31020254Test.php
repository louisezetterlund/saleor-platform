...
class Q9ca2cf4116c75bb2a7716cec31020254Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": null, "warehouseIds": ["V2FyZWhvdXNlOjkxMWY4ODMwLTg3ZjUtNDE3MC05MGU1LWFjMjZmOWMzMDY5NQ=="]}}}, "operationName": ""}
JSON;
