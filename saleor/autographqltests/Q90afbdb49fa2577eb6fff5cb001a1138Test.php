...
class Q90afbdb49fa2577eb6fff5cb001a1138Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"gte": "110"}, "warehouseIds": ["V2FyZWhvdXNlOjI5NTliMzA3LWUyNTEtNDQxNC05ZDNkLTFlMGYwZjRkZmUzMw=="]}}}, "operationName": ""}
JSON;
