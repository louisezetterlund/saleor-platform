...
class Qa446fe70a3a55dabbd1e0d6590c6200eTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n    query (\n        $first: Int, $last: Int, $after: String, $before: String,\n        $sortBy: ProductOrder, $filter: ProductFilterInput\n    ){\n        products (\n            first: $first, last: $last, after: $after, before: $before,\n            sortBy: $sortBy, filter: $filter\n        ) {\n            edges {\n                node {\n                    name\n                    slug\n                }\n            }\n            pageInfo{\n                startCursor\n                endCursor\n                hasNextPage\n                hasPreviousPage\n            }\n        }\n    }\n", "variables": {"first": 3, "after": null, "sortBy": {"attributeId": "QXR0cmlidXRlOjY3NQ==", "direction": "ASC"}}, "operationName": ""}
JSON;
