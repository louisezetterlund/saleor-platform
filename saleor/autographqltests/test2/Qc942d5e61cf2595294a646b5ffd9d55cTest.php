...
class Qc942d5e61cf2595294a646b5ffd9d55cTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n    query (\n        $first: Int, $last: Int, $after: String, $before: String,\n        $sortBy: ProductOrder, $filter: ProductFilterInput\n    ){\n        products (\n            first: $first, last: $last, after: $after, before: $before,\n            sortBy: $sortBy, filter: $filter\n        ) {\n            edges {\n                node {\n                    name\n                    slug\n                }\n            }\n            pageInfo{\n                startCursor\n                endCursor\n                hasNextPage\n                hasPreviousPage\n            }\n        }\n    }\n", "variables": {"first": 2, "after": null, "filter": {"stocks": {"warehouseIds": ["V2FyZWhvdXNlOjlhNmJkZmY1LTc4NTgtNGQ1Zi1hOWI2LTBiNDk1Y2QyYjViZQ=="], "quantity": {"lte": 10}}}}, "operationName": ""}
JSON;
