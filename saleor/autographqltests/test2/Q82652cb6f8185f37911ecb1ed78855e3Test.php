...
class Q82652cb6f8185f37911ecb1ed78855e3Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\nquery Products($sortBy: ProductOrder) {\n    products(first: 10, sortBy: $sortBy) {\n      edges {\n        node {\n          id\n          publicationDate\n        }\n      }\n    }\n}\n", "variables": {"sortBy": {"direction": "ASC", "field": "PUBLICATION_DATE"}}, "operationName": ""}
JSON;
        ...
        $this->assertArrayHasKey('publicationDate', $responseContent['products']['edges'][$g]['node']);
        
        if ($responseContent['products']['edges'][$g]['node']['publicationDate']) {
