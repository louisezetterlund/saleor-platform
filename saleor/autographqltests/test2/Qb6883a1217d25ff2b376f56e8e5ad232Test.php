...
class Qb6883a1217d25ff2b376f56e8e5ad232Test extends TestCase
{
...
JSON;
        ...
        $this->assertArrayHasKey('totalCount', $responseContent['productVariants']);
        
        if ($responseContent['productVariants']['totalCount']) {
        
        $this->assertIsInt($responseContent['productVariants']['totalCount']);
