...
class Qa0f96f14a19652938c4185a3ac45e5b9Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": null, "warehouseIds": ["V2FyZWhvdXNlOjhhMjcwNjUwLTRlNDUtNGIxNC1hM2EwLWVlMWQyMjE5NmNlOA=="]}}}, "operationName": ""}
JSON;
