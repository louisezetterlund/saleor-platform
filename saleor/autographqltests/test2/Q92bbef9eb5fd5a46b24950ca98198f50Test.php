...
class Q92bbef9eb5fd5a46b24950ca98198f50Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"gte": "10"}, "warehouseIds": ["V2FyZWhvdXNlOmQ3YTA0N2IzLThiNzQtNDc3Yy05YjNlLTZmZmMzNjU2M2I5Mw=="]}}}, "operationName": ""}
JSON;
