...
class Qda6a92db23395c17b49c14817505ba49Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": null, "warehouseIds": ["V2FyZWhvdXNlOmMxYzFmNDczLWFhOTEtNGNkYi04ZGY0LTQ3MDAzZWFiZDE0Yg=="]}}}, "operationName": ""}
JSON;
