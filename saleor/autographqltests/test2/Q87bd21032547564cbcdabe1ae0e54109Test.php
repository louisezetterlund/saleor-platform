...
class Q87bd21032547564cbcdabe1ae0e54109Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"lte": "120", "gte": "40"}, "warehouseIds": ["V2FyZWhvdXNlOmZkMGY4ZGNlLTdiNmYtNDA4Ny1hY2I1LTIwNjkxODI4YjY0Yw==", "V2FyZWhvdXNlOjJlMmJiOGZhLTdiOTUtNDM5Yi1hYWYwLTg1ODQ4NDRiNzdjYw=="]}}}, "operationName": ""}
JSON;
