...
class Qcc47c33c316151419d2094a100610ef3Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"lte": "120", "gte": "40"}, "warehouseIds": ["V2FyZWhvdXNlOmE1MGNlZTc5LWYyOGUtNGU3My1iMzBjLTgxYjcwNTFkNDc1MA==", "V2FyZWhvdXNlOjczZDRiZGRmLTExZWMtNGRkMi1iMGUzLTg5ZmJiNDMyNzk4Yg=="]}}}, "operationName": ""}
JSON;
