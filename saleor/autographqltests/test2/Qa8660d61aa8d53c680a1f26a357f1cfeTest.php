...
class Qa8660d61aa8d53c680a1f26a357f1cfeTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n        query ($filter: ProductFilterInput!, ) {\n          products(first:5, filter: $filter) {\n            edges{\n              node{\n                id\n                name\n              }\n            }\n          }\n        }\n        ", "variables": {"filter": {"stocks": {"quantity": {"gte": "110"}, "warehouseIds": ["V2FyZWhvdXNlOjBiZjBlY2MxLWEyMDMtNDI2Ni1hMmE0LTFjY2M4ZWY2ZjFiYg=="]}}}, "operationName": ""}
JSON;
