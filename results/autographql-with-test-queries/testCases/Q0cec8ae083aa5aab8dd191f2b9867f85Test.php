...
class Q0cec8ae083aa5aab8dd191f2b9867f85Test extends TestCase
{
...
JSON;
        ...
        $this->assertArrayHasKey('valueRequired', $responseContent['attributes']['edges'][$g]['node']);
        
        $this->assertNotNull($responseContent['attributes']['edges'][$g]['node']['valueRequired']);
        
        $this->assertIsBool($responseContent['attributes']['edges'][$g]['node']['valueRequired']);
