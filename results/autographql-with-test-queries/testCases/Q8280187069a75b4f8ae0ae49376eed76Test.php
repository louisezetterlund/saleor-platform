...
class Q8280187069a75b4f8ae0ae49376eed76Test extends TestCase
{
...
JSON;
        ...
        $this->assertArrayHasKey('description', $responseContent['products']['edges'][$g]['node']);
        
        $this->assertNotNull($responseContent['products']['edges'][$g]['node']['description']);
        
        $this->assertIsString($responseContent['products']['edges'][$g]['node']['description']);
