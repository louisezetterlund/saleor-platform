...
class Q91e72d0bd56155289e51a44fce0b4102Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query Category($id: ID!) {\n  category(id: $id) {\n    seoDescription\n    seoTitle\n    id\n    name\n    backgroundImage {\n      url\n      __typename\n    }\n    ancestors(last: 5) {\n      edges {\n        node {\n          id\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n  attributes(filter: {inCategory: $id, filterableInStorefront: true}, first: 100) {\n    edges {\n      node {\n        id\n        name\n        slug\n        values {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": [{"slug": "flavor", "value": "salty-like-the-tears-of-your-enemy"}], "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": {"field": "NAME", "direction": "DESC"}, "id": "Q2F0ZWdvcnk6OA=="}, "operationName": "Category"}
JSON;
