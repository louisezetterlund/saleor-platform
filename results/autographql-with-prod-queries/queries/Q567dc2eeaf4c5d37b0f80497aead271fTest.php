...
class Q567dc2eeaf4c5d37b0f80497aead271fTest extends TestCase
{
...
JSON;
        ...
        $this->assertEquals('AttributeCountableConnection' , $responseContent['search']['__typename']);
        ...
        $this->assertEquals('AttributeCountableEdge' , $responseContent['search']['edges'][$g]['__typename']);
        
        $this->assertArrayHasKey('node', $responseContent['search']['edges'][$g]);
        
        $this->assertNotNull($responseContent['search']['edges'][$g]['node']);
        
        $this->assertEquals('Attribute' , $responseContent['search']['edges'][$g]['node']['__typename']);
        ...
        if ($responseContent['search']['edges'][$g]['node']['name']) {
