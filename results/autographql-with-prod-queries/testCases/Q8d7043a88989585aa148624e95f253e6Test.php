...
class Q8d7043a88989585aa148624e95f253e6Test extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query Collection($id: ID!) {\n  collection(id: $id) {\n    id\n    slug\n    name\n    seoDescription\n    seoTitle\n    backgroundImage {\n      url\n      __typename\n    }\n    __typename\n  }\n  attributes(filter: {inCollection: $id, filterableInStorefront: true}, first: 100) {\n    edges {\n      node {\n        id\n        name\n        slug\n        values {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": {}, "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": {"field": "MINIMAL_PRICE", "direction": "ASC"}, "id": "Q29sbGVjdGlvbjoy"}, "operationName": "Collection"}
JSON;
