...
class Qbad2f1168e2559cbb7adf9b58f60234eTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "query Category($id: ID!) {\n  category(id: $id) {\n    seoDescription\n    seoTitle\n    id\n    name\n    backgroundImage {\n      url\n      __typename\n    }\n    ancestors(last: 5) {\n      edges {\n        node {\n          id\n          name\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n  attributes(filter: {inCategory: $id, filterableInStorefront: true}, first: 100) {\n    edges {\n      node {\n        id\n        name\n        slug\n        values {\n          id\n          name\n          slug\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n", "variables": {"attributes": [{"slug": "bucket-size", "value": "1l"}], "pageSize": 6, "priceGte": null, "priceLte": null, "sortBy": {"field": "NAME", "direction": "ASC"}, "id": "Q2F0ZWdvcnk6MjA="}, "operationName": "Category"}
JSON;
