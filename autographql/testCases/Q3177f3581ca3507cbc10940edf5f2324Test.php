...
class Q3177f3581ca3507cbc10940edf5f2324Test extends TestCase
{
...
JSON;
        ...
        $this->assertArrayHasKey('slug', $responseContent['products']['edges'][$g]['node']['variants'][$f]['attributes'][$e]['values'][$d]);
        
        if ($responseContent['products']['edges'][$g]['node']['variants'][$f]['attributes'][$e]['values'][$d]['slug']) {
        
        $this->assertIsString($responseContent['products']['edges'][$g]['node']['variants'][$f]['attributes'][$e]['values'][$d]['slug']);
