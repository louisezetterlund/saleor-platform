...
class Q0b24d2175b9f5b1ca031e785f8c9803fTest extends TestCase
{
    ...
    public function testGraphQL()
    {
        ...
        $query = <<<'JSON'
{"query": "\n    query (\n        $first: Int, $last: Int, $after: String, $before: String,\n        $sortBy: VoucherSortingInput, $filter: VoucherFilterInput\n    ){\n        vouchers(\n            first: $first, last: $last, after: $after, before: $before,\n            sortBy: $sortBy, filter: $filter\n        ) {\n            edges {\n                node {\n                    name\n                }\n            }\n            pageInfo{\n                startCursor\n                endCursor\n                hasNextPage\n                hasPreviousPage\n            }\n        }\n    }\n", "variables": {"first": 3, "after": null, "sortBy": {"field": "MINIMUM_SPENT_AMOUNT", "direction": "ASC"}}, "operationName": ""}
JSON;
